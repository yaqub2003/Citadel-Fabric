        ...
        if (entity.getAnimation() == null) {
            ...
            if (entity.getAnimation() != IAnimatedEntity.NO_ANIMATION) {
                if (entity.getAnimationTick() == 0) {
                    ...
                    if (!AnimationEvent.START.invoker().onAnimationStart(event)) {
                ...
                if (entity.getAnimationTick() < entity.getAnimation().getDuration()) {
                    ...
                    AnimationEvent.TICK.invoker().onAnimationTick(new AnimationEvent.Tick<>(entity, entity.getAnimation(), entity.getAnimationTick()));
                }
                if (entity.getAnimationTick() == entity.getAnimation().getDuration()) {
